...
class KNet_delta_s(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.device = device
        self.to(self.device)
        # self.const = nn.Parameter(torch.tensor([100.]), requires_grad=True)
    ...
    def InitSequence(self, M1_0, T):
        ...
        # self.innov_array = torch.zeros((self.n, self.T)).to(dev, non_blocking=True)
        # self.s_array = torch.zeros((self.n, self.n, self.T)).to(dev, non_blocking=True)
    ...
    def KNet_step(self, y):
        ...
        # print(self.KGain)
        self.KGain = self.KGain / 100 ############################for rival only
        # print(self.KGain)
    ...
    def forward(self, y):
        ...
        return self.dy, self.x_out, torch.abs(self.S_t)
