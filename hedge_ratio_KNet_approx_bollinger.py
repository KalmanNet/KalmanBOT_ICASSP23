...
KNet_approx_bollinger_train(training_set, q2, r2, R_0, beta_0, F, f, H, h, T, T_test, train_size, train_size, dataFolderName)    

cum_pnl = KNet_approx_bollinger_test(df, dataFolderName, dev, beta_0, len(df))
# print(cum_pnl)
cum_pnl = cum_pnl.cpu().numpy()
np.save(dataFolderName+'cum_KNet_approx_bollinger_end_to_end', cum_pnl)
